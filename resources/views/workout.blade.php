...
<main class="container text-center py-5 animate__animated animate__fadeIn min-vw-80">
    ...
    <div class="row justify-content-evenly g-4">
      ...
      <div id="workout-results" class="row row-cols-1 row-cols-md-2 g-4 mt-4 p-4 animate__animated animate__fadeInUp">
                ...
                if (response.workouts.length > 0) {
                    response.workouts.forEach(workout => {
                     $('#workout-results').append(`
                        <div class="col">
                        <div class="bg-dark rounded-3 p-3 border border-success shadow-lg animate__animated animate__fadeInUp h-100">
                        ...
                        <span class="badge bg-warning text-dark">${workout.muscle_group}</span>
                        </div>
                        </div>
                    `);
                });
